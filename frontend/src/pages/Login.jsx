    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 bg-background overflow-hidden relative">
            ...
            <div className="absolute inset-0 opacity-30">
                ...
                <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-secondary/15 rounded-full blur-[120px] animate-pulse" style={{ animationDelay: '1s' }}></div>
            ...
            <div className="w-full max-w-md relative z-10">
                <div className="glass-card p-8 border-white/5">
                    <div className="flex flex-col items-center mb-10 text-center">
                        ...
                        <p className="text-gray-400">Securely sign in to your crypto portfolio</p>
                    </div>
